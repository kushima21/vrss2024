            ...
            <div class="admin--monitoring--container--box">
                <div class="admin--monitoring--header">
                    ...
                    <div class="admin--monitoring--chooses">
                        <ul>
                            <li><a href="admin_monitoring.php" style="color: red;">All Reservation</a></li>
                ...
                <?php 
    // SQL query to filter out specific statuses and order by request time
    $fetchadata = "SELECT * FROM reservation_request WHERE status != 'Completed' ORDER BY request_time ASC";
