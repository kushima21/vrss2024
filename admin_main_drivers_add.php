...
<div class="container">
        ...
        <div class="main">
                    ...
                    <a href="admin_main_drivers.php"><span><i class="fa-solid fa-arrow-left"></i>Go Back</span></a>
                     ...
                     <div class="admin--drivers--vehicle--container--add">
                        <form method="post" action="" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="">
                            <div class="admin--drivers--box--container">
                                           ...
                                           <br>
                                                 <button type="submit" name="submit" value="Add Drivers" onclick="return confirm('Are you sure you want to save these?');">Saved</button>
