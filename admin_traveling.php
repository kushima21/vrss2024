...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    ...
    if ($action == 'accept') {
        ...
        if ($stmt) {
            ...
            $updateQuery = "UPDATE reservation_request SET status = 'Completed', payment_status = 'Completed', date_completed = NOW(), vehicle_status = 'Completed' WHERE reservation_id = ?";
        ...
        $updateQuery = "UPDATE reservation_request SET status = 'Traveling', payment_status = 'Traveling', vehicle_status = 'Traveling' WHERE reservation_id = ?";
        $stmt = mysqli_prepare($con, $updateQuery);
        ...
        if ($stmt) {
            ...
            if ($currentStatus != 'Completed') {
                ...
                if ($stmt) {
                    ...
                    if ($result) {
                        // Update vehicle status to 'Completed' for the specific reservation
                        ...
                        if ($stmt_vehicle) {
                            ...
                            if ($vehicleUpdateResult) {
                                echo '<script>alert("Reservation completed, vehicle status updated to Completed!");</script>';
                            } else {
                                echo "Error updating vehicle status: " . mysqli_error($con);
                            }
                        } else {
...
<div class="container">
                ...
                <div class="admin--monitoring--header">
                    ...
                    <div class="admin--monitoring--chooses">
                        <ul>
                            ...
                            <li><a href="admin_traveling.php"  style="color: red;"> Travelling</a></li>
    ...
    $fetchadata = "SELECT * FROM reservation_request WHERE status = 'Traveling'";
        ...
        <div class="admin--customers--monitoring--box">
            ...
            <div class="admin--additional--details">
                ...
                <div class="setting--rental--reservation--form--button">
                    <button type="button" onclick="submitForm(this)">To Completed</button>
                </div> 
            </div>
        </div>
    </form>
...
<script>
    function submitForm(button) {
        ...
        form.querySelector('input[name="action"]').value = 'completed';
        form.submit();
    }
</script>
