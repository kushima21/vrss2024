                  ...
                  <div class="user--right--side--header"><h2>My Reservation</h2></div>
                    <div class="user--url--main--container">
                      <ul>
                        ...
                        <li><a href="user_main_transaction_history.php" style="color: darkred;">Request </a></li>
                    ...
                    $stmt = $con->prepare("SELECT * FROM reservation_request WHERE email = ? AND status = 'Pending'");
                    ...
                    ?>   
                        <div class="reservation--container--box">
                          ...
                          <a href="user_main_transaction_view.php?reservation_id=<?php echo $reservation_id; ?>"><button>View Reservation</button></a>
                            <a href="user_main_cancel_transaction_form.php?reservation_id=<?php echo $reservation_id; ?>"><button>Cancel</button></a>
                          </div>
                        </div>
                        <?php
                        }
