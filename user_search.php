...
if (isset($_SESSION['email'])) {
    $loggedInEmail = $_SESSION['email']; // Retrieve the logged-in user's email
    ...
    // If user data is found, process it
    if ($result && mysqli_num_rows($result) > 0) {
        // Fetch user details
        $row = $result->fetch_assoc();
        $id = $row['id'];
...
<div class="user--search--container">
    ...
    <div class="user--search--vehicle--container">
        ...
        <!-- Container to display vehicle names -->
