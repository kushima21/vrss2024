                    ...
                    <div class="admin--main--customers--container--box">
                        <div class="admin--customers--form--containers">
                            ...
                            <div class="admin--additional--details">
                                ...
                                <p style="color: red;"><?php echo htmlspecialchars($reservation_data['date_completed']); ?></p>
                                ...
                                <div class="button--customers"><a href="admin_customers.php"><button>Get Back</button></a></div>
                            </div>
