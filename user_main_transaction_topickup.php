                  ...
                  <div class="user--right--side--header"><h2>My Reservation</h2></div>
                    <div class="user--url--main--container">
                      <ul>
                        ...
                        <li><a href="user_main_transaction_topickup.php" style="color: darkred;">ToPickup</a></li>
                    ...
                    ?> 
                        <div class="reservation--container--box">
                          ...
                          <a href="user_main_transaction_topickup_view.php?reservation_id=<?php echo $reservation_id; ?>"><button>View Reservation</button></a>
