    ...
    <div class="container">
            ...
            <div class="admin--customers--main--container">
                <div class="admin--customers--main--box">
                    <div class="admin--customers--header--box">
                        ...
                        <ul>
                            <a href="admin_customers.php" style="color: red;"><li style="color: red;">All</li></a>
                            <a href="admin_customers_completed.php"><li>Completed</li></a>
                            <a href="admin_customers_cancelled.php"><li>Cancelled</li></a>
                        </ul>
                    </div>
        ...
        $fetchadata = "SELECT * FROM reservation_request";
    ...
    ?>
                        <div class="admin--customers--form--containers">
                            ...
                            <div class="admin--additional--details">
                                ...
                                <h1>DateCompleted</h1>
                                <p style="color: red;"><?php echo $date_completed; ?></p>
                            ...
                            <div class="admin--view--reservation--cancel--button">
                                <a href="admin_customersview.php?reservation_id=<?php echo $reservation_id; ?>"><button>View Reservation</button></a>
                            </div>
                        </div>
                        <?php } ?>  
                    </div>
