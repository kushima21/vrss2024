                ...
                <div class="user--main--right--side--container">
                  <div class="user--right--side--header"><h2>My Reservation</h2></div>
                    <div class="user--url--main--container">
                      <ul>
                        <li><a href="user_main_transaction_all.php" style="color: darkred;">All</a></li>
                    ...
                    $stmt = $con->prepare("SELECT * FROM reservation_request WHERE email = ? AND status IN ('Completed', 'Cancelled')");
                    ...
                    ?> 
                        <div class="reservation--container--box">
                          ...
                          <a href="user_main_transaction_all_view.php?reservation_id=<?php echo $reservation_id; ?>"><button>View Reservation</button></a>
