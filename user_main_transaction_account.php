...
<head>
    ...
    <link rel="stylesheet" href="user_main_transaction_account.css?= <?php echo time();?>">
                    ...
                    <div class="user--reservation--main--container--box">
                        <div class="reservation--container--box">
                            ...
                            <div class="button--edit--container">
                                        <a href="user_main_transaction_accountEdit.php?edit_id=<?php echo $id; ?>"><button type="button">Change Information</button></a>
                                    </div>
                          </div>
                        </div>
