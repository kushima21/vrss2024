            ...
            <div class="user--main--transaction----box">
                ...
                <div class="user--main--right--side--container">
                  <div class="user--right--side--header"><h2>My Reservation</h2></div>
                    ...
                    $stmt = $con->prepare("SELECT * FROM reservation_request WHERE email = ? AND status = 'Completed'");
                    ...
                    ?> 
                        <div class="reservation--container--box">
                          ...
                          <a href="user_main_transaction_completed_view.php?reservation_id=<?php echo $reservation_id; ?>"><button>View Reservation</button></a>
                            <a href="#"><button>Reserved Again</button></a>
                          </div>
                        </div>
                        <?php
                        }
